...
class AvgMedInc extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    render() {
        return (
          ...
          >
            <p> This is a table showing the average median income per race for</p>
            <SelectField
